...
const state = {
  ...
  unsubTx:null, unsubRotinas:null, unsubMetaStatus:null, unsubInv:null, unsubCampos:null, unsubPerfil:null, unsubCats:null, unsubContas:null,
...
document.querySelectorAll('nav.tabs button').forEach(b=>{
  b.onclick=()=>{
    ...
    ['dash','tx','relat','mercado','contas','metas','pets'].forEach(t=>
