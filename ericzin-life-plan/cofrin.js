...
const PETS=[
  ...
  // novos comum (67)
  ['abelha','Abelha','comum'],['antilope','Antílope','comum'],['atum','Atum','comum'],['avestruz','Avestruz','comum'],['babuino','Babuíno','comum'],
  ...
  ['cavala','Cavala','comum'],['cavalo','Cavalo','comum'],['cavalo-quadrado','Cavalo Quadrado','comum'],['cavalo-selvagem','Cavalo Selvagem','comum'],
  ['coala','Coala','comum'],['coelho-branco','Coelho Branco','comum'],['coiote','Coiote','comum'],['corvo','Corvo','comum'],['emu','Emu','comum'],
  ['enguia','Enguia','comum'],['estrela-do-mar','Estrela-do-mar','comum'],['foca','Foca','comum'],['formiga','Formiga','comum'],
  ...
  ['linguado','Linguado','comum'],['lula','Lula','comum'],['macaco','Macaco','comum'],['ovelha','Ovelha','comum'],
  ['ovelha-quadrada','Ovelha Quadrada','comum'],['pato','Pato','comum'],['peixe-cinza','Peixe Cinza','comum'],
  ['peixe-laranja','Peixe Laranja','comum'],['peixe-agulha','Peixe-agulha','comum'],['peixinho','Peixinho','comum'],['pinguim','Pinguim','comum'],
  ['pintinho','Pintinho','comum'],['plantinha','Plantinha','comum'],['polvinho','Polvinho','comum'],['porco','Porco','comum'],
  ['porco-quadrado','Porco Quadrado','comum'],['pug','Pug','comum'],['raposa','Raposa','comum'],['rato','Rato','comum'],['salmao','Salmão','comum'],
